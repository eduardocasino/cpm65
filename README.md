...
### KIM-1 with Corsham's SD Shield notes
  ...
  - As for the SD variant above, for KIM-1 clones without cassette routines, you can place the `bootsdshield-kimrom.bin` bootloader into the free space of the KIM-1 rom, starting at 0x1AA0.
